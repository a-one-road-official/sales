...
def failure_code(*values: object) -> str:
    ...
    rules = (
        ("RECAPTCHA_OR_BOT_DEFENSE", ("recaptcha", "captcha", "turnstile", "bot", "access_denied", "403")),
        ("FORM_NOT_FOUND", ("form_not_found", "no_form", "問い合わせフォーム", "form")),
        ("EMAIL_NOT_FOUND", ("no_channel_found", "email_not_found", "メールアドレス", "recipient")),
        ("IFRAME_UNSUPPORTED", ("iframe", "frame_unsupported")),
        ("OCR_NOT_AVAILABLE", ("ocr", "ocr_not_started", "image_text")),
        ("SEARCH_UNAVAILABLE", ("web_search", "search", "gemini", "vertex")),
        ("SHEETS_QUOTA", ("429", "rate_limit", "quota")),
        ("TIMEOUT", ("timeout", "timed out", "deadline")),
        ("DUPLICATE_BLOCKED", ("duplicate", "idempotency")),
        ("AUTHORIZATION", ("401", "permission", "unauthorized")),
